    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav mx-auto gap-4">
                <li class="nav-item">
                    <a class="nav-link text-white active animate__animated animate__fadeIn animate__delay-1s" href="{{route('home')}}">Market</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light animate__animated animate__fadeIn animate__delay-1.2s" href="{{route('shop')}}">Mine</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light animate__animated animate__fadeIn animate__delay-1.4s" href="{{route('buydeposit')}}">Shop</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light animate__animated animate__fadeIn animate__delay-1.6s" href="{{route('deposit')}}">Deposit</a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex align-items-center gap-4">
                @auth
                <span class="fw-semibold text-white animate__animated animate__fadeIn animate__delay-2s">{{Auth::user()->balance}}</span>
                @endauth

                <!-- My Cart Icon -->
                    @auth
                <a href="#" class="text-white d-flex align-items-center gap-2 animate__animated animate__bounceIn animate__delay-2.2s my-cart-icon">
